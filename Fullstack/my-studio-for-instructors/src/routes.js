...
const routes = [
  ...
  {
    exact: true,
    path: '/app/account/zoom_auth',
    component: lazy(() =>
      import('src/views/app/AccountView/Settings/ZoomRedirectPage')
    )
  },
  {
    path: '/app',
    ...
    routes: [
      {
        exact: true,
        path: '/app/account',
        component: lazy(() => import('src/views/app/AccountView'))
      },
      {
        exact: true,
        path: '/app/calendar',
      ...
      },
      {
        ...
        component: lazy(() => import('src/views/app/Notifications'))
      },
      {
        exact: true,
        path: '/app/projects',
      ...
      },
      {
        exact: true,
        path: '/app/home',
        component: lazy(() => import('src/views/app/HomeView'))
      },
      {
        exact: true,
        path: '/app/financials',
        component: lazy(() => import('src/views/app/FinancialView'))
      },
      {
        exact: true,
        path: '/app/events',
        component: lazy(() => import('src/views/app/EventView/EventListView'))
      },
      {
        exact: true,
        path: '/app/events/create',
        component: lazy(() => import('src/views/app/EventView/EventCreateView'))
      },
      {
        exact: true,
        path: '/app/events/edit',
        component: lazy(() => import('src/views/app/EventView/EventEditView'))
      },
      {
        exact: true,
        path: '/app/events/view',
        component: lazy(() => import('src/views/app/EventView/EventView'))
      },
      {
        exact: true,
        path: '/app/classes',
        component: lazy(() => import('src/views/app/ClassView/ClassListView'))
      },
      {
        exact: true,
        path: '/app/classes/create',
        component: lazy(() => import('src/views/app/ClassView/ClassCreateView'))
      },
      {
        exact: true,
        path: '/app/classes/view',
        component: lazy(() => import('src/views/app/ClassView/ClassView'))
      },
      {
        exact: true,
        path: '/app/classes/edit',
        component: lazy(() => import('src/views/app/ClassView/ClassEditView'))
      },
      {
        exact: true,
        path: '/app/social',
